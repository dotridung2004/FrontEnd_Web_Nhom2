            ...
            children: [
              LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  // Tính toán chiều cao hàng, nhưng đảm bảo không nhỏ hơn 52
                  final double calculatedRowHeight = availableHeight / 10;
                  final double rowHeight = calculatedRowHeight < 52 ? 52 : calculatedRowHeight;

                  // Bọc SizedBox bằng SingleChildScrollView
                  return SingleChildScrollView(
                    child: SizedBox(
                      width: double.infinity,
                      child: DataTable(
                        dataRowHeight: rowHeight, // Sử dụng chiều cao đã tính
